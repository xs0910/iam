...
// If the input is a singular error, only that error is tested.
// If the input implements the Aggregate interface, the list of errors will be processed recursively.
//
