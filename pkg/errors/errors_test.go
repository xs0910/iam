...
func TestCause(t *testing.T) {
	...
	tests := []struct {
		...
		{err: nil, want: nil},
		{err: (error)(nil), want: nil},
		{err: (*nilError)(nil), want: (*nilError)(nil)},
		{err: io.EOF, want: io.EOF},
		{err: Wrap(io.EOF, "ignored"), want: io.EOF},
		{err: x, want: x},
		{WithMessage(nil, "whoops"), nil},
		{WithMessage(io.EOF, "whoops"), io.EOF},
		{WithStack(nil), nil},
		{WithStack(io.EOF), io.EOF},
	}
