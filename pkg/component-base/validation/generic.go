...
func IsQualifiedName(value string) []string {
	...
	case 2:
		...
		} else if msg := IsDNS1123Subdomain(prefix); len(msg) != 0 {
			errs = append(errs, prefixEach(msg, "prefix part ")...)
		}
	default:
		return append(
			errs,
			"a qualified name "+RegexError(qualifiedNameErrMsg, qualifiedNameFmt, "MyName", "my.name", "123-abc")+
...
func prefixEach(msg []string, prefix string) []string {
	for i := range msg {
		msg[i] = prefix + msg[i]
	}
	return msg
